import { Container, Form, Rodape, Botaoadm,Pontoadm, Titulo1,
  ...
  Logados, Time, TimeN, DadosM, DadosJ} from "./Styles";
  ...
  return (
    ...
    <Form>
      ...
      <PontoLigado>
        ...
        <Labela> TEMPO </Labela>
        <Botaoligado> 
         <BotaoGenerico height = "100%" width ="100%" name= "Desligar Ponto" backgroundColor= "#BC0E03" color="#d9d9d9" hoverBackgroundColor="#990D03" />
          </Botaoligado>
